...
namespace DGTradesIn.Models
{
    ...
    public partial class GameProjectEntities : DbContext
    {
        public GameProjectEntities()
            : base("name=GameProjectEntities")
        {
        }
        ...
        public virtual DbSet<CartGameCode> CartGameCodes { get; set; }
